  ...
  <div class="about">
    ...
    >
      <v-card elevation="0">
        ...
        <span><br>Enat Peanut Butter እናት የኣቸሎኒ ቅቤ is one of the leading peanut butter companies in Ethiopia. Our mission is to create delicious, healthy and sustainable products that satisfy our customers' taste buds. We use only the finest quality peanuts and ingredients to ensure that our peanut butter is rich in flavor and packed with nutrients. From classic smooth and crunchy varieties to unique flavors like honey and spicy, we have something for everyone. Try Eat Peanut Butter today!</span>
      </v-card>
    </v-col>
    <v-col
      cols="12"
